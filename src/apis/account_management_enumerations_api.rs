...
pub async fn gw_api_v1_enumerations_enumeration_type_get(configuration: &configuration::Configuration, enumeration_type: &str, currency: Option<&str>, ib_entity: Option<&str>, md_status_non_pro: Option<&str>, form_number: Option<&str>) -> Result<serde_json::Value, Error<GwApiV1EnumerationsEnumerationTypeGetError>> {
