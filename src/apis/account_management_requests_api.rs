...
pub async fn gw_api_v1_requests_request_id_status_get(configuration: &configuration::Configuration, request_id: &str, r#type: Option<&str>) -> Result<serde_json::Value, Error<GwApiV1RequestsRequestIdStatusGetError>> {
