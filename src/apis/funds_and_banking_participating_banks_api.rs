...
pub async fn gw_api_v1_participating_banks_client_id_get(
    configuration: &configuration::Configuration,
    client_id: &str,
    r#type: &str,
) -> Result<models::GetParticipatingListResponse, Error<GwApiV1ParticipatingBanksClientIdGetError>>
{
    ...
    let local_var_uri_str = format!(
        "{}/gw/api/v1/participating-banks/{clientId}",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GwApiV1ParticipatingBanksClientIdGetError> =
