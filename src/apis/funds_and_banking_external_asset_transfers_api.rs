...
pub async fn gw_api_v1_external_asset_transfers_client_id_post(
    configuration: &configuration::Configuration,
    client_id: &str,
    gw_api_v1_external_asset_transfers_client_id_post_request: models::GwApiV1ExternalAssetTransfersClientIdPostRequest,
    ...
    let local_var_uri_str = format!(
        "{}/gw/api/v1/external-asset-transfers/{clientId}",
    ...
    local_var_req_builder =
        local_var_req_builder.json(&gw_api_v1_external_asset_transfers_client_id_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GwApiV1ExternalAssetTransfersClientIdPostError> =
