...
pub enum GwApiV1AccountsAccountIdDetailsGetError {
    Status400(models::AccountDetailsResponse),
    Status403(models::ErrorResponse),
    Status500(models::AccountDetailsResponse),
...
pub enum GwApiV1AccountsAccountIdKycGetError {
    Status400(models::Au10TixDetailResponse),
    Status403(models::ErrorResponse),
    Status500(models::Au10TixDetailResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GwApiV1AccountsAccountIdLoginMessagesGetError {
    ...
    Status403(models::ErrorResponse),
    Status500(models::LoginMessageResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GwApiV1AccountsAccountIdStatusGetError {
    Status400(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status500(models::AccountStatusResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum GwApiV1AccountsAccountIdTasksGetError {
    Status400(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status500(models::RegistrationTasksResponse),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`gw_api_v1_accounts_close_client_id_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GwApiV1AccountsCloseClientIdPostError {
...
pub enum GwApiV1AccountsGetError {
    Status400(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status500(models::GwApiV1AccountsGet200Response),
    UnknownValue(serde_json::Value),
}
...
pub async fn gw_api_v1_accounts_close_client_id_post(configuration: &configuration::Configuration, client_id: &str, gw_api_v1_accounts_close_client_id_post_request: models::GwApiV1AccountsCloseClientIdPostRequest) -> Result<models::InstructionResponse, Error<GwApiV1AccountsCloseClientIdPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/gw/api/v1/accounts/close/{clientId}", local_var_configuration.base_path, clientId=crate::apis::urlencode(client_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());

    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    local_var_req_builder = local_var_req_builder.json(&gw_api_v1_accounts_close_client_id_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GwApiV1AccountsCloseClientIdPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
