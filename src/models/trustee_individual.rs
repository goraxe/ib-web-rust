...
pub struct TrusteeIndividual {
    ...
    pub residence_address: Option<Box<models::Address>>,
    ...
    #[serde(rename = "nfaRegistered", skip_serializing_if = "Option::is_none")]
    pub nfa_registered: Option<bool>,
    #[serde(rename = "nfaRegistrationNumber", skip_serializing_if = "Option::is_none")]
    pub nfa_registration_number: Option<String>,
}

impl TrusteeIndividual {
    pub fn new() -> TrusteeIndividual {
        TrusteeIndividual {
            name: None,
            native_name: None,
            birth_name: None,
