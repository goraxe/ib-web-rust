...
impl AchInstruction {
    pub fn new(client_instruction_id: String, bank_instruction_code: BankInstructionCode, ach_type: AchType, bank_instruction_name: String, currency: String, account_id: String, client_account_info: models::AchInstructionClientAccountInfo) -> AchInstruction {
        AchInstruction {
