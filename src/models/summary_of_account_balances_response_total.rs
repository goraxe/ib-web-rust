...
/// SummaryOfAccountBalancesResponseTotal : Contains total balance details for the account.
...
pub struct SummaryOfAccountBalancesResponseTotal {
    ...
    #[serde(rename = "Nt Lqdtn Uncrtnty", skip_serializing_if = "Option::is_none")]
...
impl SummaryOfAccountBalancesResponseTotal {
    /// Contains total balance details for the account.
    pub fn new() -> SummaryOfAccountBalancesResponseTotal {
        SummaryOfAccountBalancesResponseTotal {
            net_liquidation: None,
            nt_lqdtn_uncrtnty: None,
