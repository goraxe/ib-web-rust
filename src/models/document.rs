...
pub struct Document {
    ...
    #[serde(rename = "isValidAddress", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "externalAcctId", skip_serializing_if = "Option::is_none")]
    pub external_acct_id: Option<String>,
