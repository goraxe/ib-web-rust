...
pub struct FormW8Ben {
    ...
    #[serde(rename = "isTinOrExplanationRequired", skip_serializing_if = "Option::is_none")]
    pub is_tin_or_explanation_required: Option<bool>,
    ...
    #[serde(rename = "isBlankForm", skip_serializing_if = "Option::is_none")]
    pub is_blank_form: Option<bool>,
    ...
    #[serde(rename = "isElectronicFormat", skip_serializing_if = "Option::is_none")]
    pub is_electronic_format: Option<bool>,
...
impl FormW8Ben {
    pub fn new() -> FormW8Ben {
        FormW8Ben {
            ...
            tin: None,
            foreign_tax_id: None,
            is_tin_or_explanation_required: None,
            explanation: None,
