...
pub struct AutomatedWrapFeeDetailsType {
    ...
    #[serde(rename = "annualBlendedPercentage", skip_serializing_if = "Option::is_none")]
    pub annual_blended_percentage: Option<Vec<models::AnnualBlendedPercentage>>,
    #[serde(rename = "navRange", skip_serializing_if = "Option::is_none")]
    pub nav_range: Option<Vec<models::NavRangeType>>,
...
impl AutomatedWrapFeeDetailsType {
    pub fn new() -> AutomatedWrapFeeDetailsType {
        AutomatedWrapFeeDetailsType {
            ...
            annual_blended_percentage: None,
            nav_range: None,
            r#type: None,
            max_fee: None,
            num_contracts: None,
