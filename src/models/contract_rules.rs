...
pub struct ContractRules {
    ...
    #[serde(rename = "orderOrigination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "displaySize", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "priceMagnifier", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
