...
pub struct PartialOptionPosition {
    #[serde(rename = "symbol", skip_serializing_if = "Option::is_none")]
    pub symbol: Option<String>,
    #[serde(rename = "numberOfContracts", skip_serializing_if = "Option::is_none")]
...
impl PartialOptionPosition {
    pub fn new() -> PartialOptionPosition {
