...
pub struct PortfolioSummaryTotaldebitcardpendingchargesC {
...
impl PortfolioSummaryTotaldebitcardpendingchargesC {
    pub fn new() -> PortfolioSummaryTotaldebitcardpendingchargesC {
