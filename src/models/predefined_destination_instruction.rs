...
pub struct PredefinedDestinationInstruction {
    ...
    pub currency: String,
    #[serde(rename = "financialInstitution", skip_serializing_if = "Option::is_none")]
    pub financial_institution: Option<Box<models::PredefinedDestinationInstructionFinancialInstitution>>,
}

impl PredefinedDestinationInstruction {
    pub fn new(client_instruction_id: String, bank_instruction_name: String, bank_instruction_method: BankInstructionMethod, account_id: String, currency: String) -> PredefinedDestinationInstruction {
