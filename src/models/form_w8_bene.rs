...
pub struct FormW8Bene {
    #[serde(rename = "substantialUsOwners", skip_serializing_if = "Option::is_none")]
    pub substantial_us_owners: Option<Box<models::SubstantialUsOwners>>,
    ...
    #[serde(rename = "tinOrExplanationReqdToCreateAccounts", skip_serializing_if = "Option::is_none")]
    pub tin_or_explanation_reqd_to_create_accounts: Option<bool>,
...
impl FormW8Bene {
    pub fn new() -> FormW8Bene {
        FormW8Bene {
            ...
            giin: None,
            foreign_tin: None,
            tin_or_explanation_reqd_to_create_accounts: None,
            explanation: None,
