...
pub struct PortfolioSummaryLookaheadexcessliquidityC {
...
impl PortfolioSummaryLookaheadexcessliquidityC {
    pub fn new() -> PortfolioSummaryLookaheadexcessliquidityC {
