...
pub struct ExtPositionsTransferType {
    #[serde(rename = "partialStockPositions", skip_serializing_if = "Option::is_none")]
    pub partial_stock_positions: Option<Vec<models::PartialStockPosition>>,
    #[serde(rename = "partialBondPositions", skip_serializing_if = "Option::is_none")]
    pub partial_bond_positions: Option<Vec<models::PartialBondPosition>>,
    #[serde(rename = "partialOptionPositions", skip_serializing_if = "Option::is_none")]
    pub partial_option_positions: Option<Vec<models::PartialOptionPosition>>,
    #[serde(rename = "partialWarrantPositions", skip_serializing_if = "Option::is_none")]
    pub partial_warrant_positions: Option<Vec<models::PartialWarrantPosition>>,
    #[serde(rename = "partialFundPositions", skip_serializing_if = "Option::is_none")]
    pub partial_fund_positions: Option<Vec<models::PartialFundPosition>>,
    #[serde(rename = "partialCashPositions", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "approximateAccountValue", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "authorizeToRemoveFund", skip_serializing_if = "Option::is_none")]
