...
pub struct IraDecedent {
    ...
    #[serde(rename = "inheritorType", skip_serializing_if = "Option::is_none")]
    pub inheritor_type: Option<InheritorType>,
    #[serde(rename = "relationship", skip_serializing_if = "Option::is_none")]
    pub relationship: Option<Relationship>,
}

impl IraDecedent {
    pub fn new() -> IraDecedent {
        IraDecedent {
            name: None,
            native_name: None,
            birth_name: None,
...
impl Default for InheritorType {
    fn default() -> InheritorType {
        Self::S
    }
}
/// 
