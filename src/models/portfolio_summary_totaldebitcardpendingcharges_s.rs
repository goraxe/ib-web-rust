...
pub struct PortfolioSummaryTotaldebitcardpendingchargesS {
...
impl PortfolioSummaryTotaldebitcardpendingchargesS {
    pub fn new() -> PortfolioSummaryTotaldebitcardpendingchargesS {
