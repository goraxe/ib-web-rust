...
pub struct GwApiV1InstructionsQueryPostRequest {
...
impl GwApiV1InstructionsQueryPostRequest {
    pub fn new(instruction_type: InstructionType, instruction: models::GetRecentInstructionsQuery) -> GwApiV1InstructionsQueryPostRequest {
