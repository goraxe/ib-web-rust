...
pub struct PortfolioSummaryNetliquidationuncertainty {
...
impl PortfolioSummaryNetliquidationuncertainty {
    pub fn new() -> PortfolioSummaryNetliquidationuncertainty {
