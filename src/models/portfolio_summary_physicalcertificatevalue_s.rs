...
pub struct PortfolioSummaryPhysicalcertificatevalueS {
...
impl PortfolioSummaryPhysicalcertificatevalueS {
    pub fn new() -> PortfolioSummaryPhysicalcertificatevalueS {
