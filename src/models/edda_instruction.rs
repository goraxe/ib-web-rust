...
impl EddaInstruction {
    pub fn new(client_instruction_id: String, bank_instruction_name: String, currency: String, account_id: String, bank_branch_code: String, bank_account_number: String, bank_clearing_code: String, debtor_identification_document_type: DebtorIdentificationDocumentType) -> EddaInstruction {
        EddaInstruction {
