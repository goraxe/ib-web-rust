...
------------ | ------------- | ------------- | -------------
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_account_id_details_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_account_id_details_get) | **GET** /gw/api/v1/accounts/{accountId}/details | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_account_id_kyc_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_account_id_kyc_get) | **GET** /gw/api/v1/accounts/{accountId}/kyc | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_account_id_login_messages_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_account_id_login_messages_get) | **GET** /gw/api/v1/accounts/{accountId}/login-messages | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_account_id_status_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_account_id_status_get) | **GET** /gw/api/v1/accounts/{accountId}/status | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_account_id_tasks_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_account_id_tasks_get) | **GET** /gw/api/v1/accounts/{accountId}/tasks | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_get**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_get) | **GET** /gw/api/v1/accounts | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_patch**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_patch) | **PATCH** /gw/api/v1/accounts | 
*AccountManagementAccountsApi* | [**gw_api_v1_accounts_post**](docs/AccountManagementAccountsApi.md#gw_api_v1_accounts_post) | **POST** /gw/api/v1/accounts | 
*AccountManagementEnumerationsApi* | [**gw_api_v1_enumerations_enumeration_type_get**](docs/AccountManagementEnumerationsApi.md#gw_api_v1_enumerations_enumeration_type_get) | **GET** /gw/api/v1/enumerations/{enumerationType} | 
*AccountManagementRequestsApi* | [**gw_api_v1_requests_request_id_status_get**](docs/AccountManagementRequestsApi.md#gw_api_v1_requests_request_id_status_get) | **GET** /gw/api/v1/requests/{requestId}/status | 
...
*FundsAndBankingAccountsApi* | [**gw_api_v1_accounts_close_client_id_post**](docs/FundsAndBankingAccountsApi.md#gw_api_v1_accounts_close_client_id_post) | **POST** /gw/api/v1/accounts/close/{clientId} | Initiate account closure request for the provided account
*FundsAndBankingBankInstructionsApi* | [**gw_api_v1_bank_instructions_client_id_post**](docs/FundsAndBankingBankInstructionsApi.md#gw_api_v1_bank_instructions_client_id_post) | **POST** /gw/api/v1/bank-instructions/{clientId} | Initiate a banking instruction (currently only ACH, eDDA, Delete) for the provided IB account
*FundsAndBankingBankInstructionsApi* | [**gw_api_v1_bank_instructions_query_client_id_post**](docs/FundsAndBankingBankInstructionsApi.md#gw_api_v1_bank_instructions_query_client_id_post) | **POST** /gw/api/v1/bank-instructions/query/{clientId} | Bank instruction Queries
*FundsAndBankingClientInstructionsApi* | [**gw_api_v1_client_instructions_client_id_client_instruction_id_get**](docs/FundsAndBankingClientInstructionsApi.md#gw_api_v1_client_instructions_client_id_client_instruction_id_get) | **GET** /gw/api/v1/client-instructions/{clientId}/{clientInstructionId} | Poll status of an Internal Cash Transfer for given instruction id.
*FundsAndBankingExternalAssetTransfersApi* | [**gw_api_v1_external_asset_transfers_client_id_post**](docs/FundsAndBankingExternalAssetTransfersApi.md#gw_api_v1_external_asset_transfers_client_id_post) | **POST** /gw/api/v1/external-asset-transfers/{clientId} | External Asset transfer (FOP, DWAC , Complex Asset Transfer)
*FundsAndBankingExternalCashTransfersApi* | [**gw_api_v1_external_cash_transfers_client_id_post**](docs/FundsAndBankingExternalCashTransfersApi.md#gw_api_v1_external_cash_transfers_client_id_post) | **POST** /gw/api/v1/external-cash-transfers/{clientId} | External Cash transfers (Deposit and Withdraw fund)
*FundsAndBankingExternalCashTransfersApi* | [**gw_api_v1_external_cash_transfers_query_client_id_post**](docs/FundsAndBankingExternalCashTransfersApi.md#gw_api_v1_external_cash_transfers_query_client_id_post) | **POST** /gw/api/v1/external-cash-transfers/query/{clientId} | Get Withdrawable Cash Queries
*FundsAndBankingFeeTemplatesApi* | [**gw_api_v1_fee_templates_client_id_post**](docs/FundsAndBankingFeeTemplatesApi.md#gw_api_v1_fee_templates_client_id_post) | **POST** /gw/api/v1/fee-templates/{clientId} | Initiate a fee template request for provided account
*FundsAndBankingFeeTemplatesApi* | [**gw_api_v1_fee_templates_query_client_id_post**](docs/FundsAndBankingFeeTemplatesApi.md#gw_api_v1_fee_templates_query_client_id_post) | **POST** /gw/api/v1/fee-templates/query/{clientId} | Get fee template details
*FundsAndBankingInstructionSetsApi* | [**gw_api_v1_instruction_sets_client_id_instruction_set_id_get**](docs/FundsAndBankingInstructionSetsApi.md#gw_api_v1_instruction_sets_client_id_instruction_set_id_get) | **GET** /gw/api/v1/instruction-sets/{clientId}/{instructionSetId} | Poll status of multiple Internal Cash Transfers for given instruction set id.
*FundsAndBankingInstructionsApi* | [**gw_api_v1_instructions_cancel_client_id_post**](docs/FundsAndBankingInstructionsApi.md#gw_api_v1_instructions_cancel_client_id_post) | **POST** /gw/api/v1/instructions/cancel/{clientId} | Initiate a cancel instruction request for provided instructionId
*FundsAndBankingInstructionsApi* | [**gw_api_v1_instructions_client_id_instruction_id_get**](docs/FundsAndBankingInstructionsApi.md#gw_api_v1_instructions_client_id_instruction_id_get) | **GET** /gw/api/v1/instructions/{clientId}/{instructionId} | Poll status of an Internal Cash Transfer for given instruction id.
*FundsAndBankingInstructionsApi* | [**gw_api_v1_instructions_query_client_id_post**](docs/FundsAndBankingInstructionsApi.md#gw_api_v1_instructions_query_client_id_post) | **POST** /gw/api/v1/instructions/query/{clientId} | Get Recent Instructions
*FundsAndBankingInternalAssetTransfersApi* | [**gw_api_v1_internal_asset_transfers_client_id_post**](docs/FundsAndBankingInternalAssetTransfersApi.md#gw_api_v1_internal_asset_transfers_client_id_post) | **POST** /gw/api/v1/internal-asset-transfers/{clientId} | Asset transfers within IB
*FundsAndBankingInternalCashTransfersApi* | [**gw_api_v1_internal_cash_transfers_client_id_post**](docs/FundsAndBankingInternalCashTransfersApi.md#gw_api_v1_internal_cash_transfers_client_id_post) | **POST** /gw/api/v1/internal-cash-transfers/{clientId} | Cash transfer within IB
*FundsAndBankingParticipatingBanksApi* | [**gw_api_v1_participating_banks_client_id_get**](docs/FundsAndBankingParticipatingBanksApi.md#gw_api_v1_participating_banks_client_id_get) | **GET** /gw/api/v1/participating-banks/{clientId} | Get list of participating banks
*ReportingStatementsApi* | [**gw_api_v1_statements_post**](docs/ReportingStatementsApi.md#gw_api_v1_statements_post) | **POST** /gw/api/v1/statements | Generates statements in supported formats based on request parameters.
...
## Documentation For Models
 ...
 - [AddAdditionalAcct](docs/AddAdditionalAcct.md)
 ...
 - [BrokerageService](docs/BrokerageService.md)
 ...
 - [ControllerDetailsType](docs/ControllerDetailsType.md)
 - [ControllingPersonType](docs/ControllingPersonType.md)
 ...
 - [DuplicateAcctRequest](docs/DuplicateAcctRequest.md)
 ...
 - [FeesTemplateBasedType](docs/FeesTemplateBasedType.md)
 - [FinancialInformation](docs/FinancialInformation.md)
 - [FinancialOrgType](docs/FinancialOrgType.md)
 ...
 - [MdServicesType](docs/MdServicesType.md)
 ...
 - [RegulatedMemberships](docs/RegulatedMemberships.md)
 ...
 - [SubstantialUsOwner](docs/SubstantialUsOwner.md)
 - [SubstantialUsOwners](docs/SubstantialUsOwners.md)
